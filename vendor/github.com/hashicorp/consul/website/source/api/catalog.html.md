...
[agent endpoints](/agent/api-v1/api-server/agent.html) for registration as they are simpler and
...
[agent endpoints](/agent/api-v1/api-server/agent.html) for deregistration as they are simpler and
perform [anti-entropy](/docs/internals/anti-entropy.html).
