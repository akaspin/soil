...
*   <a name="acl_replication_token"></a><a href="#acl_replication_token">`acl_replication_token`</a> -
    ...
    and then set the token later using the [agent token API](/agent/api/api-server/agent.html#update-acl-tokens) on each
...
* <a name="enable_acl_replication"></a><a href="#enable_acl_replication">`enable_acl_replication`</a> When
  ...
  and then introduce the token using the [agent token API](/agent/api/api-server/agent.html#update-acl-tokens) on each server.
...
*   <a name="translate_wan_addrs"</a><a href="#translate_wan_addrs">`translate_wan_addrs`</a> If
    ...
    datacenter. An [`X-Consul-Translate-Addresses`](/agent/api/api-server/index.html#translated-addresses) header
    ...
    - [`/v1/catalog/nodes`](/agent/api/api-server/catalog.html#catalog_nodes)
    - [`/v1/catalog/node/<node>`](/agent/api/api-server/catalog.html#catalog_node)
    - [`/v1/catalog/service/<service>`](/agent/api/api-server/catalog.html#catalog_service)
    - [`/v1/health/service/<service>`](/agent/api/api-server/health.html#health_service)
    - [`/v1/query/<query or name>/execute`](/agent/api/api-server/query.html#execute)
