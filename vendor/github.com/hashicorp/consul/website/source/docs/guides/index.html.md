...
* [Geo Failover](/docs/guides/geo-failover.html) - This guide covers using [prepared queries](/agent/api-v1/api-server/query.html) to implement geo failover for services.
