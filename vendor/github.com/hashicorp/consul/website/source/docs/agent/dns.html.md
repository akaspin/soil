...
[Prepared Query](/agent/api/api-server/query.html). These behave like standard service
...
added support for [prepared query templates](/agent/api/api-server/query.html#templates)
