...
[Prepared Query](/agent/api-v1/api-server/query.html). These behave like standard service
...
added support for [prepared query templates](/agent/api-v1/api-server/query.html#templates)
