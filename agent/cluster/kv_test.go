...
func TestKV_Configure(t *testing.T) {
	...
	t.Run(`submit on zero`, func(t *testing.T) {
		...
		fixture.WaitNoError(t, time.Millisecond*100, 100, consumer.CompareMessagesFn(
	...
	t.Run(`ensure resubmit volatile after crash`, func(t *testing.T) {
		...
		fixture.WaitNoError(t, time.Millisecond*100, 5, consumer.CompareMessagesFn(
			bus.NewMessage("test", map[string]interface{}{
				"pre-volatile": map[string]interface{}{
					"Data": map[string]string{"1": "1"},
					"TTL":  true,
	...
	t.Run(`add and remove`, func(t *testing.T) {
		...
		fixture.WaitNoError(t, time.Millisecond*100, 10, consumer.CompareMessagesFn(
			bus.NewMessage("test", map[string]interface{}{
				"pre-volatile": map[string]interface{}{
					"Data": map[string]string{"1": "1"},
					"TTL":  true,
...
func TestKV_Subscribe(t *testing.T) {
	...
	t.Run(`put 1`, func(t *testing.T) {
		...
		fixture.WaitNoError(t, time.Millisecond*300, 10, cons1.CompareMessagesFn(
