...
func Print(v ...interface{}) {
	std.appendLine(lInfo, fmt.Sprint(v...))
}

// Printf is synonym to standard Log Infof used for compatibility.
func Printf(format string, v ...interface{}) {
	std.appendLine(lInfo, fmt.Sprintf(format, v...))
}
